...
(defun setup-template-tables ()
  (dbi:with-connection (conn :postgres
                             :username (captools.config:get-db-config :username)
                             :password (captools.config:get-db-config :password)
                             :port (captools.config:get-db-config :port)
                             :database-name (captools.config:get-db-config :database-name))
